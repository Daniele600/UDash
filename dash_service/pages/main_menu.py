...
from dash_service.models import Dashboard, Splashpage
import unicodedata
...
def layout(project_slug=None, page_slug=None, lang="en", **query_params):
    ...
    if all_splashpages is not None and len(all_splashpages)>0:
        ...
        for spl in all_splashpages:
            ...
            tbl_rows_sp.append(html.Tr([html.Td(spl.project.name),html.Td(spl.title),html.Td(lnk)]))
        tbl_body_menu = [html.Tbody(tbl_rows_sp)]
